...
import { MdOutlineHotel, MdOutlineCleaningServices, MdOutlinePlace, MdOutlineWifi} from "react-icons/md";
  ...
  return (
    <>
      <div className="mx-4 my-16">
        <h1 className="text-3xl font-semibold">Khách sạn JWMariot thành phố Hồ Chí Minh</h1>
        <div className="flex my-2">
          <span className="text-[20px]">
            <MdPlace />
          </span>
          <p className="text-sm">Quận 1, thành phố Hồ Chí Minh</p>
        </div>
        ...
        <div className="py-4 ">
          <img
            src="https://a0.muscache.com/im/pictures/d0ca15e5-87bc-4912-bbc0-6c564e42afc7.jpg?im_w=720"
            alt=""
            layout="fill"
        ...
        <div className='mt-6 mb-12'>
          <p className='text-2sm'>
            Nằm ở thành phố Hồ Chí Minh, khách sạn thuộc chuỗi khách sạn sang trọng, đẳng cấp quốc tế
            cách Bãi Sau 4 phút đi bộ, The JWMariot cung cấp chỗ nghỉ
            có phòng chờ chung, chỗ đậu xe riêng miễn phí và sân hiên. Ngoài Wi-Fi miễn phí, khách
            sạn 3 sao này còn cung cấp bếp chung và dịch vụ phòng. Chỗ nghỉ này cung cấp quầy lễ tân
            24 giờ, dịch vụ tiền sảnh và phòng giữ hành lý cho khách. 
            <br/>
            <br/>
            Tất cả các căn đi kèm điều
            hòa, TV màn hình phẳng có truyền hình vệ tinh, tủ lạnh, ấm đun nước, vòi xịt/chậu rửa vệ
            sinh, đồ vệ sinh cá nhân miễn phí và tủ quần áo. Ngoài phòng tắm riêng với vòi sen và
            máy sấy tóc, một số phòng tại khách sạn cũng có view thành phố. Tại JWMariot, tất cả các phòng có ga trải giường và khăn tắm.
            <br/>
            <br/>
            Các điểm tham quan nổi tiếng
            gần chỗ nghỉ bao gồm Bãi Trước, Mũi Nghinh Phong và Bến tàu cánh ngầm.
            <br/>
            <br/>
            Mọi người biệt thích địa điểm này — họ cho điểm <span className='text-blue-600'>9,2</span> cho kỳ nghỉ dành cho 2 người.
          </p>
        </div>
        <div className='my-12'>
          <div className='flex items-center justify-center w-full h-32 font-medium border rounded-xl '>
            <div className='flex items-center grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'>
              ...
              <div className='px-8 mx-8 border-l border-r'>
                <p className='text-xl text-center'>Đây là một trong những nơi được yêu thích nhất trên Airbnb
                <br/> Với đầy đủ các tiện nghi
                </p>
              </div>
              <div className='pr-8 mr-8 border-r'>
                <p className='items-center p-4 text-xl font-medium text-center text-white bg-blue-500 border rounded-xl'>9.2</p>
                {/* < BsStarFill className='text-sm'/> */}
              </div>
              <div className='items-center'>
                <p className='text-xl font-medium underline cursor-pointer'>609 đánh giá</p>
              </div>
            </div>
          </div>
        </div>
        <div className='my-12'>
          ...
          <div className='mt-4 mb-4 '>
            ...
            <div className='flex items-center pb-6 border-b text-2sm'>
              <IoWifi className='text-green'/> <span className='ml-1 mr-4'>Wifi miễn phí</span>
              <LuParkingCircle/> <span className='ml-1 mr-4'>Chổ đỗ xe miễn phí</span>
              <IoLogoNoSmoking/> <span className='ml-1 mr-4'>Phòng không hút thuốc</span>
              <FaPeopleGroup/> <span className='ml-1 mr-4'>Dịch vụ phòng</span>
            </div>
            ...
            <div className='items-center mx-auto mt-10 text-center'>
              <div className='flex justify-center'>
                <img 
                  ...
                  className='w-34 h-44'
                />
                <p className='items-center text-[5rem] font-semibold text-center'>
                  9.2
                </p>
                <img
            ...
            <div className='flex items-center pb-8 my-12 font-medium border-b'>
              <div className='p-2 border-r w-44'>
                ...
                <p className='items-center w-10 p-[5px] text-lg mb-4 text-center text-white bg-blue-500 rounded-lg'>9.6</p>
                <FaPeopleGroup/>
              </div>
              <div className='p-2 border-r w-44'>
