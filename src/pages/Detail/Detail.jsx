  ...
  return (
    <>
      <div className="mx-4 my-16">
        ...
        <div className='my-12'>
          <div className='flex items-center w-full h-32 p-8 font-medium border rounded-xl '>
            <div className='flex items-center'>
              ...
              <div className='px-8 mx-8 border-r'>
        ...
        <div className='my-12'>
          ...
          <div className='mt-4 mb-4 '>
            ...
            <h2 className='mt-6 mb-2 text-2xl font-semibold'>Đánh giá của khách hàng</h2>
