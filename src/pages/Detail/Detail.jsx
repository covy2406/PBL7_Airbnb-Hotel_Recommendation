      ...
      <div className="mx-4 my-16">
        ...
        <div className="flex my-2">
          ...
          <p
            ...
            onClick={() => window.open(`https://www.google.com/maps/search/${detailHotel.address}`)}>
            {detailHotel.address}
          </p>
        </div>
        <div className="flex items-center justify-center w-full py-4 rounded-xl">
          <div>
            <img src={detailHotel.image} alt={detailHotel.name} layout="fill" className="relative w-[400px] h-96 m-1" />
          </div>
          <div className="flex items-center">
            <div>
              <img src={detailHotel.image} alt={detailHotel.name} layout="fill" className="relative w-[400px] h-48 m-1" />
              <img src={detailHotel.image} alt={detailHotel.name} layout="fill" className="relative w-[400px] h-48 m-1" />
            </div>
            <div>
              <img src={detailHotel.image} alt={detailHotel.name} layout="fill" className="relative w-[400px] h-48 m-1" />
        ...
        <div className="mt-6 mb-12">
          <p className="text-justify text-2sm">
            {detailHotel.description}
            <br />
            <br />
            Mọi người biệt thích địa điểm này — họ cho điểm <span className="text-blue-600">{detailHotel.avgScore}</span> cho kỳ
            nghĩ tại đây
          </p>
        </div>
        <div className="my-12">
            ...
            <div className="flex items-center grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              ...
              <div className="px-8 mx-8 border-l border-r">
                <p className="text-xl text-center">
                  Đây là một trong những nơi được yêu thích nhất trên Airbnb
              ...
              <div className="items-center">
                <p className="text-xl font-medium cursor-pointer">{detailHotel.HotelRatings?.length} Đánh giá</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="items-center mx-auto mt-10 text-center">
              <div className="flex justify-center">
                <img
                  ...
                  className="w-34 h-44"
                />
                <p className="items-center text-[5rem] font-semibold text-center">{detailHotel.avgScore}</p>
                <img
          ...
          {rcmd?.length > 0 && (
            <>
              ...
              <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4">
                {rcmd.map((rcmdItem) => (
                  <HotelRecommendLogin key={rcmdItem.user_id} rcmdItem={rcmdItem} />
                ))}
              </div>
            </>
          )}
