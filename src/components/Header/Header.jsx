        ...
        <div className="flex items-center justify-between h-28 sm:mx-6 md:mx-10 lg:mx-12 ">
          ...
          <Link className="flex h-6" component={Link} to={'/'}>
            <svg
              ...
              width="102"
              height="32"
              className={`${scrolling ? 'text-[#1976D2]' : 'text-white'} items-center fill-current xl:block`}>
                ...
                <ul className="list-none">
                  {suggestions.map((suggestion, index) => (
                    <Link component={Link} to={`/hotels/${suggestion.id}`}>
                      <li
                        key={index}
                        className="flex items-center p-2 text-sm font-normal border-b cursor-pointer hover:bg-slate-100">
