    ...
    <>
      <div className="items-center p-3 border-2 rounded-3xl bg-slate-100">
        <div className="flex items-center py-3">
          ...
          <div className="ml-2">
            <span className="text-sm font-bold">{cmt.user_name}</span>
            <div className="text-sm text-gray-500">{calculateTimeFromNow(cmt.createAt)}</div>
          </div>
        </div>
        <div className="mb-3 text-2sm border-b pb-4">
